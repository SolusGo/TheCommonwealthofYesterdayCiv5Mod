...
('TXT_KEY_CIV5_COMMONWEALTH_TEXT_5',
 ...
 || '[NEWLINE][NEWLINE]' ||
 'Adjacent Old Friends may also speak to one another. Each eligible pair begins with a 15% chance per turn to produce an exchange, increased during a Reminiscence and near a Childhood Bedroom. Each eligible miss adds 10 percentage points, and four consecutive misses guarantee an exchange. Era changes, upgrades, close calls, victories, Reminiscence activations, and reunions after a long separation enter persistent event queues at a 75% base chance, gaining 8 percentage points after each miss. Global, pair, and dialogue-history cooldowns keep the system from becoming repetitive, and conversations can be disabled in the Ledger.'),
...
-- Spy names.
('TXT_KEY_SPY_COMMONWEALTH_NIGHTLIGHT','The Nightlight'),
('TXT_KEY_SPY_COMMONWEALTH_PLAYER_TWO','Player Two'),
('TXT_KEY_SPY_COMMONWEALTH_PORCHLIGHT','Porchlight'),
('TXT_KEY_SPY_COMMONWEALTH_OLD_SAVE','Old Save'),
('TXT_KEY_SPY_COMMONWEALTH_QUIET_LOGIN','Quiet Login'),
('TXT_KEY_SPY_COMMONWEALTH_SPARE_KEY','The Spare Key'),
('TXT_KEY_SPY_COMMONWEALTH_AFTER_MIDNIGHT','After Midnight'),
('TXT_KEY_SPY_COMMONWEALTH_LAST_ONLINE','Last Online'),
('TXT_KEY_SPY_COMMONWEALTH_PAPER_STAR','Paper Star'),
('TXT_KEY_SPY_COMMONWEALTH_HOME_SIGNAL','Home Signal'),
('TXT_KEY_SPY_COMMONWEALTH_SECOND_CONTROLLER','Second Controller'),
('TXT_KEY_SPY_COMMONWEALTH_FORGOTTEN_PASSWORD','Forgotten Password'),
