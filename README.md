...
**Repository version: 1.0.43** — this documentation version is independent of the in-game ModBuddy version, which intentionally remains `1`.
...
| 1.0.43 | Current | Expanded Harrison and Lachlan's tribute gamertags. |
