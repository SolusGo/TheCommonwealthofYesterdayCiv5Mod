...
**Repository version: 1.0.21** — this documentation version is independent of the in-game ModBuddy version, which intentionally remains `1`.
...
| 1.0.21 | Current | Fixed custom DDS metadata for city-view icons. |
