...
**Repository version: 1.0.20** — this documentation version is independent of the in-game ModBuddy version, which intentionally remains `1`.
...
| 1.0.20 | Current | Refined unique-component and leader icon framing. |
