...
**Repository version: 1.0.45** — this documentation version is independent of the in-game ModBuddy version, which intentionally remains `1`.
...
| 1.0.45 | Current | Added the Commonwealth spy roster. |
