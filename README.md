...
**Repository version: 1.0.48** — this documentation version is independent of the in-game ModBuddy version, which intentionally remains `1`.
...
| 1.0.48 | Current | Restored Years Together buffs after recovered upgrades. |
