...
**Repository version: 1.0.39** — this documentation version is independent of the in-game ModBuddy version, which intentionally remains `1`.
...
| 1.0.39 | Current | Restored the Old Friend's missing manual upgrade path. |
