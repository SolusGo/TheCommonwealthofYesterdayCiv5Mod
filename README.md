...
**Repository version: 1.0.34** — this documentation version is independent of the in-game ModBuddy version, which intentionally remains `1`.
...
| 1.0.34 | Current | Restyled the Old Friends Ledger in Commonwealth colors. |
