...
**Repository version: 1.0.44** — this documentation version is independent of the in-game ModBuddy version, which intentionally remains `1`.
...
| 1.0.44 | Current | Retired temporary profiles created during upgrades. |
